...
// Define variables
static const uint32_t channelArray[VTX_BAND_MAX][VTX_CHANNEL_MAX] = {
...
{
    band = constrain(band, VTX_BAND_MIN, VTX_BAND_MAX);
    channel = constrain(channel, VTX_CHANNEL_MIN, VTX_CHANNEL_MAX);
...
{
    freq = constrain(freq, VTX_FREQ_MIN, VTX_FREQ_MAX);
