...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
...
#if 0
    // For iNav, PWM5&6 pins are assigned to UART3 and PWM7&8 pins are assigned to I2C
    // UART3 RX/TX
    ...
    // PWM7 and PWM8 
    // SDA / SCL
    { TIM4,  IO_TAG(PB7),  TIM_Channel_2, TIM4_IRQn,               1, IOCFG_AF_PP, GPIO_AF_2 }, // Pin PWM7 - PB7
    { TIM4,  IO_TAG(PB6),  TIM_Channel_1, TIM4_IRQn,               1, IOCFG_AF_PP, GPIO_AF_2 }, // Pin PWM8 - PB6
#endif
