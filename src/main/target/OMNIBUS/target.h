...
// No RSSI support for OMNIBUS F3 (fow now)
...
// For iNav, SBUS/PPM selection jumpers must be configured to use PPM+UART3
...
#define USABLE_TIMER_CHANNEL_COUNT 6 // 4 Outputs; PPM; LED Strip;
